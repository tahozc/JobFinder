...
import "../../pages/CreateJob/index.css";
    ...
    <div className="create-job-container">
      <div className="create-job-card">
        <div className="create-job-row">
          <div className="create-job-header">Edit Job</div>
        </div>
        <div className="create-job-row">
        ...
        <div className="create-job-row">
          <div className="create-job-column">
            <div className="auth-form-item">
              <div className="auth-form-label">Enter Application Deadline</div>
              <Datepicker
        ...
        <div className="create-job-row signle-item">
          <Button text={"Edit Job"} onClick={EditCompanysJob} />
        </div>
        {isLoading && <Loader />}
      </div>
    </div>
...
export default withDashboard(EditJob);
